...
- [`git clone https://github.com/Metsanpeitto/hello_rails_react`](https://github.com/Metsanpeitto/hello_rails_react)


### Setup

```cmd
$ git clone  https://github.com/Metsanpeitto/hello_rails_react.git
